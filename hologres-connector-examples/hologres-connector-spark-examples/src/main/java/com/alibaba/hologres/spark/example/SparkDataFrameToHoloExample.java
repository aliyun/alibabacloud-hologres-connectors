...
public class SparkDataFrameToHoloExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        df.write()
                .format("hologres")
                .option(SourceProvider$.MODULE$.USERNAME(), userName)
                .option(SourceProvider$.MODULE$.PASSWORD(), password)
                .option(SourceProvider$.MODULE$.ENDPOINT(), endPoint)
                .option(SourceProvider$.MODULE$.DATABASE(), database)
                .option(SourceProvider$.MODULE$.TABLE(), tableName)
                .save();

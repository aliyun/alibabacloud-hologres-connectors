package com.alibaba.hologres.connector.flink.api.table;
...
public interface RowDataWriter<T> extends Serializable {
    static <T> FieldWriter createFieldWriter(
            ...
            boolean enableRemoveU0000InText) {
            ...
            case "_text":
                return (obj) -> {
                    ...
                    for (int i = 0; i < arrayData.size(); i++) {
                        if (enableRemoveU0000InText) {
                            strings[i] =
                                    HologresUtils.removeU0000(arrayData.getString(i).toString());
                        } else {

...
public class PostgresTypeUtil {
	...
	public static DataType fromJDBCType(ResultSetMetaData metadata,
		...
		switch (pgType) {
			...
			case PG_NUMERIC:
				return DataTypes.DECIMAL(metadata.getPrecision(colIndex), metadata.getScale(colIndex));
			case PG_NUMERIC_ARRAY:
				return DataTypes.ARRAY(
						DataTypes.DECIMAL(metadata.getPrecision(colIndex), metadata.getScale(colIndex)));
			case PG_CHAR:
			case PG_CHARACTER:

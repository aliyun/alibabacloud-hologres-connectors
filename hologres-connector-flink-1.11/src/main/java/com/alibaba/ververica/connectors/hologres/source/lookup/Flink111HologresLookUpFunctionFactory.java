...
public class Flink111HologresLookUpFunctionFactory implements HologresLookUpFunctionFactory {
    @Override
    public AsyncFunction<RowData, RowData> createAsyncFunction(
        ...
        return new HologresAsyncLookupFunction(
                sqlTableName, tableSchema, index, cacheStrategy, hologresReader);
    }

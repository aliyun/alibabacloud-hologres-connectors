...
- 可以 spark-shell --jars hologres-connector-spark-2.x-1.3.2-SNAPSHOT-jar-with-dependencies.jar，然后spark-shell里执行测试
...
```shell
pyspark --jars hologres-connector-spark-2.x-1.3-SNAPSHOT-jar-with-dependencies.jar
```

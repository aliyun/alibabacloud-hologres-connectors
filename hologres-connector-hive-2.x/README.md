...
* 永久：
    * 将hologres-connector-hive-2.x-1.5.0-SNAPSHOT-jar-with-dependencies.jar放在HiveServer2所在节点的$HIVE_HOME/auxlib目录下（目录不存在就新建）
* session级
    1. 将hologres-connector-hive-2.x-1.5.0-SNAPSHOT-jar-with-dependencies.jar上传至hdfs

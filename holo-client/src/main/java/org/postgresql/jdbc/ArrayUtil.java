...
public class ArrayUtil {
    ...
    public static byte[] arrayToBinary(BaseConnection conn, Object elements, String typeName)
            throws SQLException {
        if (elements instanceof PgArray) {
            PgArray array = (PgArray) elements;
    ...
    public static Array objectToArray(BaseConnection conn, Object obj, String typeName)
            throws SQLException {
        Array array = null;

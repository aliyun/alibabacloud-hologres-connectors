...
public class TableName implements Serializable {
    ...
    public static TableName quoteValueOf(String schemaName, String tableName)
            throws InvalidIdentifierException {
        return valueOf(
                IdentifierUtil.quoteIdentifier(schemaName, /*isCaseSensitive*/ true),
                IdentifierUtil.quoteIdentifier(tableName, /*isCaseSensitive*/ true));
    }

    public static TableName valueOf(String schemaName, String tableName)
            throws InvalidIdentifierException {
        ...
        if (tableName == null) {
            synchronized (LOCK) {
                ...
                if (tableName == null) {
                    ...
                    if (tableName == null) {
                        tableName =
                                new TableName(parsedSchemaName, parsedTableName, parsedFullName);

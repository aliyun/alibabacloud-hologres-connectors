...
public class ConfLoader {
    ...
    public static <T> T load(String file, String prefix, T config, boolean throwException)
            throws Exception {
    ...
    public static <T, I, O> T load(Map<I, O> props, String prefix, T config, boolean throwException)
            throws Exception {
        {
            ...
            for (Map.Entry<I, O> entry : props.entrySet()) {
                ...
                for (Field field : fields) {
                    if (field.getName().equalsIgnoreCase(searchKey)) {
                        ...
                        } else if (OnConflictAction.class.equals(type)) {
                            field.set(config, OnConflictAction.valueOf(value));

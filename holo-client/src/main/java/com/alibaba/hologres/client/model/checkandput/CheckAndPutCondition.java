...
public class CheckAndPutCondition implements Serializable {
    ...
    /**
     * @return boolean true: new value check with old value. false: old value is null or is not null
     *     or no provide checkValue.
     */
    public boolean isNewValueCheckWithOldValue() {
        return checkOp != CheckCompareOp.IS_NOT_NULL

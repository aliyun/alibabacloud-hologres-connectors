...
public class TableSchema implements Serializable {
    ...
    public static class Builder {
        ...
        public void setIsLogicalPartitionedTable(boolean isLogicalPartitionedTable) {
            tableSchema.isLogicalPartitionedTable = isLogicalPartitionedTable;
        }
        ...
        public boolean setAutoPartitioningTimeZone(String autoPartitioningTimeZone) {
            return tableSchema.autoPartitioning.setTimeZone(autoPartitioningTimeZone);
        }

        public void setAutoPartitioningTimeZoneByOffset(int timeZoneOffsetSeconds) {
            tableSchema.autoPartitioning.setTimeZoneByOffset(timeZoneOffsetSeconds);
        }
        ...
        public void setAutoPartitioningTimeFormat(String autoPartitioningTimeFormat) {
            tableSchema.autoPartitioning.setTimeFormat(autoPartitioningTimeFormat);
        }
    ...
    private boolean isLogicalPartitionedTable = false;
    ...
    public boolean equals(Object o) {
        ...
        return tableId.equals(that.tableId) && schemaVersion.equals(that.schemaVersion);
    }
    ...
    public boolean isLogicalPartitionedTable() {
    ...
    public void convertTableIdentifier() {
        ...
        for (Column hologresColumn : this.getColumnSchema()) {
            hologresColumn.setName(
                    IdentifierUtil.quoteIdentifier(hologresColumn.getName(), this.getSensitive()));
        }
    ...
    public String toString() {
        return "TableSchema{"
                ...
                + tableName
                + ", \ndistributionKeys="
                + Arrays.toString(distributionKeys)
                + ", \nclusteringKey="
                + Arrays.toString(clusteringKey)
                + ", \nsegmentKey="
                + Arrays.toString(segmentKey)
                + ", \npartitionInfo='"
                + partitionInfo
                + '\''
                + ", \norientation='"

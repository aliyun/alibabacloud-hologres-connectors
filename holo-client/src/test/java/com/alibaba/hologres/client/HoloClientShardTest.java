...
public class HoloClientShardTest extends HoloClientTestBase {
    ...
    /** shard 双pk,pk=dk. Method: put(Put put). */
    @Test
    ...
    public void testShard003() throws Exception {
        ...
        try (Connection conn = buildConnection();
            ...
            String createSql =
                    "begin;create table "
                            + tableName
                            + "(id int not null,name text not null,address text, primary key(id,name));call set_table_property('"
                            + tableName
                            + "','distribution_key','id');end;";
    ...
    /** shard no_pk Method: put(Put put). */
    @Test
    public void testShard004() throws Exception {
        ...
        try (Connection conn = buildConnection();
            ...
            String createSql =
                    "create table "
                            + tableName
                            + "(id int not null,name text not null,address text)";
    ...
    /** shard no_pk，has dk Method: put(Put put). */
    @Test
    public void testShard005() throws Exception {
        ...
        try (Connection conn = buildConnection();
            ...
            String createSql =
                    "begin;create table "
                            + tableName
                            + "(id int not null,name text not null,address text);call set_table_property('"
                            + tableName
                            + "','distribution_key','name');end;";

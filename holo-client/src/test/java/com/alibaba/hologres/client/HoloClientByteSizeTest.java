...
/** ByteSize计算测试. 保证比较大的字段会计算，不保证完全精确 */
public class HoloClientByteSizeTest extends HoloClientTestBase {

    /** test Normal Array. Method: put(Put put). */
    @Test
    public void testNormalArray() throws Exception {
        ...
        try (Connection conn = buildConnection();
            ...
            put.setObject(
                    13,
                    new byte[] {
                        58, 48, 0, 0, 1, 0, 0, 0, 0, 0, 2, 0, 16, 0, 0, 0, 1, 0, 4, 0, 5, 0
                    });
    ...
    /** test Object Array. flush 操作进行时Object[]类型的Array会被转成PGArray插入 Method: put(Put put). */
    @Test
    ...
    /** test ArrayList Array. flush 操作进行时ArrayList类型的Array会被转成PGArray插入 Method: put(Put put). */
    @Test

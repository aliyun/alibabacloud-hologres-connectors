...
public class HoloClientTypeConvertTest extends HoloClientTestBase {
    ...
    protected void doBefore() throws Exception {
        lastTimeZone = TimeZone.getDefault();
    ...
    public void test001() throws Exception {
        ...
        try (Connection conn = buildConnection();
            ...
            String createSql =
                    "create table "
                            + tableName
                            + "(id int not null,\"aaa\" int,\"address\" text,primary key(id))";
    ...
    public void test002() throws Exception {
        ...
        logger.info(
                "=----------------------{}",
                formatter.format(formatter.parse("0000-00-00 00:00:00.000")));
        String[][] inputAndExpectList =
                new String[][] {
        ...
        try (Connection conn = buildConnection();
            ...
            String createSql =
                    "create table "
                            + tableName
                            + "(id int ,ts timestamp, tstz timestamptz,primary key(id))";
            ...
            try {
                ...
                for (int i = 0; i < inputAndExpectList.length; ++i) {
                    ...
                    Assert.assertEquals(
                            pair[1],
                            formatter.format(
                                    new java.util.Date(((Timestamp) r.getObject(1)).getTime())),
                            pair[0]);
                    Assert.assertEquals(
                            pair[1],
                            formatter.format(
                                    new java.util.Date(((Timestamp) r.getObject(2)).getTime())),
                            pair[0]);
                }
        ...
        try (Connection conn = buildConnection();
            ...
            try {
                ...
                for (int i = 0; i < inputAndExpectList.length; ++i) {
                    ...
                    Record r = client.get(get).get();
                    Assert.assertEquals(pair[1], formatter.format((Date) r.getObject(1)), pair[0]);
                }
    ...
    public void test004() throws Exception {
        ...
        String pattern = "yyyy-MM-dd HH:mm:ss.SSS";
        DateFormat formatter = new SimpleDateFormat(pattern);
        Long[] inputList = new Long[] {0L, -100L, 1010101010L, 20201213100000L};
    ...
    public void test005() throws Exception {
        ...
        String pattern = "yyyy-MM-dd HH:mm:ss.SSS";
        DateFormat formatter = new SimpleDateFormat(pattern);
        Long[] inputList = new Long[] {20201213100000L, 20201213100000123L};
        String[] expectList = new String[] {"2020-12-13 10:00:00.000", "2020-12-13 10:00:00.123"};
        HoloConfig config = buildConfig();
        try (Connection conn = buildConnection();
                HoloClient client = new HoloClient(config)) {
        ...
        try (Connection conn = buildConnection();
            ...
            try {
                ...
                for (int i = 0; i < inputList.length; ++i) {
                    ...
                    Assert.assertEquals(
                            expectList[i],
                            formatter.format((Date) r.getObject(1)),
                            "" + inputList[i]);
                }
    ...
    public void test007() throws Exception {
        ...
        String pattern = "yyyy-MM-dd";
        DateFormat formatter = new SimpleDateFormat(pattern);
        Long[] inputList = new Long[] {20201213100000L, 20201213L};
        String[] expectList = new String[] {"2020-12-13", "2020-12-13"};
        HoloConfig config = buildConfig();
        try (Connection conn = buildConnection();
                HoloClient client = new HoloClient(config)) {
    ...
    public void test008() throws Exception {
        ...
        String pattern = "yyyy-MM-dd HH:mm:ss.SSS";
        DateFormat formatter = new SimpleDateFormat(pattern);
        String[] inputList = new String[] {"0", "-100", "1010101010", "20201213100000"};
        String[] expectList = new String[inputList.length];
        for (int i = 0; i < inputList.length; ++i) {
        ...
        try (Connection conn = buildConnection();
                HoloClient client = new HoloClient(config)) {
            String tableName = "test_schema.\"holO_client_type_008\"";
            String createSchema = "create schema if not exists test_schema";
            String dropSql = "drop table if exists " + tableName;
            String createSql =
                    "create table "
    ...
    public void test009() throws Exception {
        ...
        String pattern = "yyyy-MM-dd HH:mm:ss.SSS";
        DateFormat formatter = new SimpleDateFormat(pattern);
        String[] inputList = new String[] {"2021-12-12 05:12:15.456", "2021-12-12 05:12:15.456+07"};
        String[] expectList = new String[] {"2021-12-12 05:12:15.456", "2021-12-12 06:12:15.456"};
        HoloConfig config = buildConfig();
        config.setInputStringAsEpochMsForDatetimeColumn(true);
        try (Connection conn = buildConnection();
                HoloClient client = new HoloClient(config)) {

...
打包结果名称为 hologres-connector-spark-3.x-1.4.3-SNAPSHOT-jar-with-dependencies.jar
...
- 可以 spark-shell --jars hologres-connector-spark-3.x-1.4.3-SNAPSHOT-jar-with-dependencies.jar，然后spark-shell里执行测试
...
```shell
pyspark --jars hologres-connector-spark-3.x-1.4.3-SNAPSHOT-jar-with-dependencies.jar
```
...
```shell
spark-sql --jars hologres-connector-spark-3.x-1.4.3-SNAPSHOT-jar-with-dependencies.jar
```
